...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SmartDeploymentSpec) DeepCopyInto(out *SmartDeploymentSpec) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SmartDeploymentSpec.
func (in *SmartDeploymentSpec) DeepCopy() *SmartDeploymentSpec {
	if in == nil {
		return nil
	}
	out := new(SmartDeploymentSpec)
	in.DeepCopyInto(out)
	return out
}
